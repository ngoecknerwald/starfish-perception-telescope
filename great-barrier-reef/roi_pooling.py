...
# Does this actually need to extend tf.keras.layers.Layer ?
class RoIPooling:
    def __init__(self, n_regions=10, pool_size=(4, 4), IoU_threshold=0.4):
        """
        ...
        IoU_threshold : float > 0 and < 1
            IoU threshold at which two region proposals are considered duplicates.
    ...
    def _pool_rois(feature_map, rois, pool_size):
        ...
        # Should this not just be a functools.Partial()?
